...
const ProductSection = () => {
  const features = [
    { icon: Zap, text: 'Chip A21 Pro' },
    { icon: Star, text: 'Câmera 200MP' },
  ...
  return (
    <section className="min-h-screen w-full relative">
      <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-screen">
        ...
        >
          <motion.span
            className="inline-block px-4 py-2 rounded-full bg-primary/10 border border-primary/30 text-primary font-display text-sm mb-6"
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
            viewport={{ once: true }}
