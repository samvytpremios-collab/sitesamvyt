        ...
        <div className="flex items-center justify-between h-16">
          ...
          {!isMobile && (
            <nav className="flex items-center gap-1">
              ...
              <NavLink
                to="/minhas-cotas"
                className="ml-2 px-4 py-2 rounded-lg text-sm font-medium border border-primary/30 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-200"
              ...
              <SheetContent side="right" className="w-[280px] p-0">
                ...
                <nav className="flex flex-col p-4 gap-1">
                  ...
                  <Link
                    ...
                    onClick={closeMenu}
                    className={cn(
                      'flex items-center gap-3 px-4 py-3 rounded-xl text-base font-medium mt-2 border transition-all duration-200',
